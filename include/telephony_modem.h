...
/**
 * @brief Gets the MEID (Mobile Equipment Identifier) of a mobile phone.
 * @details The MEID number is used by a CDMA network to identify valid devices
 *          and therefore can be used for stopping a stolen phone from accessing that network.
 *
 * @since_tizen 3.0
 * @privlevel public
...
/**
 * @brief Gets the ESN (Electronic Serial Number) of a mobile phone.
 * @details The ESN number is used by a CDMA network to identify valid devices
 *          and therefore can be used for stopping a stolen phone from accessing that network.
 *
 * @since_tizen 3.0
 * @privlevel public
